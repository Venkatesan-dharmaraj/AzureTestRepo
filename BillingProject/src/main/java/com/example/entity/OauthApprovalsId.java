...
public class OauthApprovalsId implements java.io.Serializable {
	...
	public OauthApprovalsId(String userId, String clientId, String scope,
			String status, Date expiresAt, Date lastModifiedAt) {
		this.userId = userId;
	...
	public boolean equals(Object other) {
		...
		return ((this.getUserId() == castOther.getUserId()) || (this
				...
				&& ((this.getLastModifiedAt() == castOther.getLastModifiedAt()) || (this
						.getLastModifiedAt() != null
						&& castOther.getLastModifiedAt() != null && this
						.getLastModifiedAt().equals(
								castOther.getLastModifiedAt())));
	}
	...
	public int hashCode() {
		...
		result = 37
				* result
				+ (getLastModifiedAt() == null ? 0 : this.getLastModifiedAt()
						.hashCode());
		return result;
	}
